...
class DbTasks is export {
  ...
  # Regenerate db/schema.raku after migrating so the schema file tracks the
  # applied migrations. Skip in the test environment (a harness migrates an
  # ephemeral database every run) and honor AR_NO_SCHEMA_DUMP as the opt-out.
  # Returns the written path, or the empty string when skipped.
